...
module Robur
  ...
  module Config
    ...
    ALLOWLIST = %w[
      MODELS TURN_TIMEOUT STALL_TIMEOUT VERIFY_TIMEOUT SHORT_SLEEP MAX_TRANSIENT COOLDOWN BOTH_WAIT
    ...
    NUMERIC_KEYS = %w[
      TURN_TIMEOUT STALL_TIMEOUT VERIFY_TIMEOUT SHORT_SLEEP MAX_TRANSIENT COOLDOWN BOTH_WAIT TAIL_LINES
