  ...
  module Commands
    ...
    def new_repo(idea, dir, emit: ->(m) { puts m })
      ...
      File.write(File.join(dir, tracker_file), <<~PLAN)
        ...
        - [ ] T0.1 (trivial, chore) scaffold project from the constraints in BRIEF.md
        - [ ] T0.2 (normal, test) verify command is green (one passing walking-skeleton test)
        - [ ] T0.3 (normal, feat) thinnest end-to-end slice

        ## Milestone 1 — _(flesh out from the brief)_
        - [ ] T1.1 (normal, feat) _(first real task toward the definition of done)_
