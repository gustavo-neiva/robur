...
- [ ] T1.6 (hard, serial) the differential harness — one-command runner
...
- [ ] T2.2 (hard, serial) Config — both conf files, and the sourced-conf decision
...
- [ ] T2.3 (normal) Config — precedence and defaults
...
- [ ] T4.4 (hard) Classifier — one JSON parser
...
- [ ] T5.2 (hard) CommitGate — same ordering, same blocks
...
- [ ] T5.3 (hard, serial) Observability — structured events as the source of truth
